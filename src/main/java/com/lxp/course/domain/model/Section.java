...
import com.lxp.course.web.dto.request.LectureRequest;
...
public class Section {
    ...
    private Section(String title, int sectionOrder) {
        this.title = title;
        this.sectionOrder = sectionOrder;
    }

    public static Section createFromRequest(SectionRequest request, int order) {
        Section newSection = new Section(request.title(), order);
        for (LectureRequest lectureReq : request.lectures()) {
            newSection.createLecture(lectureReq.title(), lectureReq.videoUrl(), lectureReq.duration());
        }
    ...
    public int calculateLectureCount() {
